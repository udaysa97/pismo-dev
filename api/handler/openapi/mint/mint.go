...
func MintNFT(services *service.Service) gin.HandlerFunc {
	return func(ctx *gin.Context) {
		requestBody := &types.OpenAPINFTMintOrder{}
		...
		if executeResponse, err = services.ExecutionSvc.OpenApiMintOrder(ctx, *requestBody); err != nil {
			return
		}
